...
- [ ] **Add focused automated coverage and verify the desktop build** — `electron/projects.test.ts:1`, `src/components/ProjectsScreen.tsx:1`. Cover validation and persistence boundaries, then run type-checks, tests, and the production build.
